...
interface HostReminder24hProps {
  bookingTitle: string
  hostName: string
  guestName: string
  guestEmail: string
...
export default function HostReminder24h({
  ...
  showDualTz = true,
}: HostReminder24hProps) {
  return (
    <Html>
      <Head />
      <Preview>Host reminder: {bookingTitle} tomorrow</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Heading style={h1}>📅 Host Reminder: Meeting Tomorrow</Heading>
            ...
            <Text style={text}>
              ...
              <strong>{guestName}</strong> ({guestEmail}) scheduled for tomorrow.
            </Text>
            ...
            <Text style={footer}>
              Need to cancel or reschedule? Use your dashboard to manage this booking.
            </Text>
          </Section>
