...
export default function Reminder1h({
  ...
  return (
    <Html>
      <Head />
      <Preview>Starting soon: {bookingTitle}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Heading style={h1}>⚡ Starting Soon: 1 Hour</Heading>
            ...
            <Text style={text}>
              Your meeting with <strong>{hostName}</strong> starts in approximately <strong>1 hour</strong>.
            </Text>
            ...
            <Text style={footer}>
              See you soon! If you need to make any last-minute changes, please contact the host.
            </Text>
          </Section>
