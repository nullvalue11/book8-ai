    ...
    <section className="mx-auto max-w-6xl px-4 md:px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      <div className="order-2 md:order-1">
        ...
        <div className="mt-6 flex gap-3">
          <a className="inline-flex h-10 items-center rounded-md px-4 font-medium bg-brand-500 text-white hover:bg-brand-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand transition">
            Start Free Trial
          </a>
          <a className="inline-flex h-10 items-center rounded-md px-4 font-medium border border-white/12 text-white/80 hover:text-white hover:border-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand transition">
            Watch Demo →
          </a>
        </div>
      </div>
      ...
      <div className="col-span-full mx-auto my-4 h-px w-full max-w-6xl bg-gradient-to-r from-transparent via-white/10 to-transparent" />
    </section>
  );
}
