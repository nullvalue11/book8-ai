  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Floating bubbles similar to booked.ai */}
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            {/* Mobile: Show hero content in phone, Desktop: Show app preview */}
            <div className="relative">
              {/* Desktop version - app preview */}
              <div className="hidden md:block">
                <IPhoneMockup showHeroContent={false} />
              </div>
              {/* Mobile version - hero content in phone */}
              <div className="block md:hidden">
                <IPhoneMockup showHeroContent={true} />
              </div>
            </div>
          </div>
        </div>
