...
// Avoid static prerender pitfalls on marketing page due to client-only reads
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background to-muted/20">
      ...
      <div className="container mx-auto max-w-7xl px-6 py-10">
        ...
        {/* Placeholder content to keep page valid; dashboard content renders under /dashboard */}
