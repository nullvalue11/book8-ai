/** Inlined GLSL — avoids .glsl loader issues on Vercel production builds. */
...
void main() {
  ...
  float noise = snoise(position * uNoiseScale + vec3(uTime * 0.3));
  vNoise = noise;

  vec3 displaced = position + normal * noise * uDisplacement * uPulse;
