...
const LINKEDIN_URL = 'https://www.linkedin.com/company/book8-ai/'
  ...
  return (
    <div className={cn('flex items-center gap-2', className)}>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Book8 AI on LinkedIn"
        className={`${linkBase} bg-[#0A66C2] text-white hover:bg-[#004182] hover:scale-105 focus-visible:ring-[#0A66C2]`}
      >
