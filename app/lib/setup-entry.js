...
/** @param {Record<string, string | undefined>} [extra] e.g. { plan: 'growth', currency: 'USD', vertical: 'barbershops', redirect: '/pricing' } */
export function setupUrlWithNewBusiness(extra = {}) {
  const q = new URLSearchParams()
  q.set('newBusiness', '1')
  if (extra.plan) q.set('plan', extra.plan)
  if (extra.currency) q.set('currency', String(extra.currency).toUpperCase())
  if (extra.vertical) q.set('vertical', extra.vertical)
