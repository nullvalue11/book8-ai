...
export function buildGoogleEventFromBooking(b) {
  ...
  return {
    ...
    description,
    start: { dateTime: new Date(b.startTime).toISOString(), timeZone: tz },
    end: { dateTime: new Date(b.endTime).toISOString(), timeZone: tz },
    extendedProperties: { private: { book8BookingId: b.id, timeZone: tz } },
  }
}

export function mergeBook8WithGoogle(book8, googleEvents, mappingsByGoogleId) {
