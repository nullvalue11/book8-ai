...
export async function sendBookingConfirmation(booking) {
  try {
    ...
    if (!guestOut.ok) {
      console.error('[email] Guest confirmation rejected', guestOut)
      return { success: false, error: guestOut.error }
    }
    ...
    if (!hostOut.ok) {
      console.error('[email] Host notification rejected', hostOut)
      return { success: false, error: hostOut.error }
    }
